...
const OMDepositRequestReview = ({ onClose }) => {
  return (
    <View style={[styles.omDepositRequestReview, styles.okBtnChildShadowBox]}>
      ...
      />
      <View style={styles.omDepositRequestReviewChild} />
    </View>
  );
};
...
export default OMDepositRequestReview;
