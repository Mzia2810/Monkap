...
const OMCashOutRequestReview = ({ onClose }) => {
  const navigation = useNavigation();

  return (
    <View style={styles.omCashOutRequestReview}>
      ...
      <View style={[styles.omCashOutRequestReviewChild, styles.childBg]} />
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  omCashOutRequestReviewChild: {
    left: 301,
    width: 59,
    height: 42,
    top: 0,
  },
  omCashOutRequestReview: {
...
export default OMCashOutRequestReview;
