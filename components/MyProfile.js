...
const MyProfile = ({ onClose }) => {
  return (
    <View style={[styles.myProfile, styles.images1Layout]}>
      <View style={[styles.images1, styles.images1Layout]} />
      <View style={[styles.myProfileChild, styles.profileLayout]} />
      <View style={[styles.myProfileItem, styles.profileLayout]} />
      ...
      <Text style={[styles.myProfile1, styles.exitTypo]}>{`My Profile `}</Text>
      <Image
        style={styles.myProfileInner}
        resizeMode="cover"
