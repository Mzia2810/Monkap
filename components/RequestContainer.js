...
const RequestContainer = ({
  ...
  return (
    <View style={[styles.sendBtn, sendBtn1Style]}>
      <View style={[styles.btnNext, styles.btnShadowBox, btnNext1Style]} />
