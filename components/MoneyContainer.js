...
const MoneyContainer = ({
  ...
  return (
    <View style={styles.headerPosition}>
      <View
        style={[styles.headerChild, styles.headerPosition, rectangleView5Style]}
      />
      ...
      <Text style={[styles.sendMoney, sendMoneyStyle]}>{transactionType}</Text>
    </View>
  );
};
