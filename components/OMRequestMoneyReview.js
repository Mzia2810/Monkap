...
const OMRequestMoneyReview = ({ onClose }) => {
  return (
    <View style={styles.omRequestMoneyReview}>
      ...
      <View style={[styles.omRequestMoneyReviewChild, styles.requestLayout]} />
      <View style={[styles.omRequestMoneyReviewItem, styles.requestLayout]} />
      <Text
      ...
      />
      <View style={[styles.omRequestMoneyReviewInner, styles.tabAreaBg]} />
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  omRequestMoneyReviewChild: {
    top: 182,
    borderColor: "#c1c1c1",
  },
  omRequestMoneyReviewItem: {
    top: 128,
    borderColor: "#ccc",
  },
  ifTheInformation: {
...
export default OMRequestMoneyReview;
