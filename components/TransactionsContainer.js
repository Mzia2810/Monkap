...
const TransactionsContainer = ({ recentTransactionsTop }) => {
  const transcHistStyle = useMemo(() => {
    return {
      ...getStyleValue("top", recentTransactionsTop),
    };
  }, [recentTransactionsTop]);

  return (
    <View style={[styles.transcHist, transcHistStyle]}>
