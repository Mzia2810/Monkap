...
const MomoOnMonkapProfile = () => {
  ...
  return (
    <>
      <View style={styles.momoOnMonkapProfile}>
        ...
        <ProfileContainer
          carImageUrl={require("../assets/rectangle-26.png")}
          vehicleImageUrl={require("../assets/rectangle-22.png")}
        />
        <NameContainer
...
export default MomoOnMonkapProfile;
