...
const NjangiMainDaily3 = () => {
  ...
  return (
    <>
      <View style={styles.njangiMainDaily3}>
        <View style={styles.njangiMainDaily3Child} />
        ...
        <View style={[styles.njangiMainDaily3Inner, styles.groupParentLayout]}>
          <View style={[styles.groupParent, styles.groupParentLayout]}>
            ...
            <SectionForm1 />
            <ExclusionSection
              njanguiErrorMessage="Sorry!! But you are not part of any weekly Njangui"
              propLeft={20}
            />
...
export default NjangiMainDaily3;
