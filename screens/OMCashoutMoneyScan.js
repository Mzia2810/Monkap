  ...
  return (
    <>
      <View style={styles.omCashoutMoneyScan}>
        ...
        <View
          style={[
            styles.omCashoutMoneyScanChild,
            styles.tabAreaBg,
            styles.btnNextShadowBox,
          ]}
        />
        ...
        <MoneyContainer1
          ...
          propLeft={89}
          onTaAreaPress={() => navigation.navigate("OMCashoutMoneyRecent")}
        />
      </View>
...
export default OMCashoutMoneyScan;
