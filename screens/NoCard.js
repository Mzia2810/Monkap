  ...
  return (
    <>
      <View style={styles.noCard}>
        ...
        <View style={styles.ccaBank}>
          <View style={[styles.ccaBankChild, styles.ccaPosition]} />
          <Text style={[styles.ccaBank1, styles.ccaPosition]}>CCA Bank</Text>
          <Image
