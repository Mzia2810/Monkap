...
import FrequentRequestsContainer from "../components/FrequentRequestsContainer";
...
const OMoneyRequestMoneyFrequent = () => {
  ...
  return (
    <>
      <View style={styles.omoneyRequestMoneyFrequent}>
        <View style={styles.images1} />
        <TransactionsHistoryContainer
          transactionHistoryText="Recent Transactions"
          onTranscHistPress={openTranscHistContainer}
        />
        <Image
          style={styles.omoneyRequestMoneyFrequentChild}
          resizeMode="cover"
        ...
        <Image
          style={[styles.omoneyRequestMoneyFrequentItem, styles.omoneyPosition]}
          resizeMode="cover"
          source={require("../assets/line-22.png")}
        />
        <View
          style={[
            styles.omoneyRequestMoneyFrequentInner,
            styles.omoneyPosition,
          ]}
        />
        <FrequentRequestsContainer
          onRectanglePressablePress={() =>
            navigation.navigate("OMoneyRequestMoneyRecent")
          }
        />
...
const styles = StyleSheet.create({
  ...
  omoneyRequestMoneyFrequentChild: {
    top: 280,
    left: 17,
    height: 3,
    width: 326,
  ...
  omoneyRequestMoneyFrequentItem: {
    top: 201,
    height: 2,
    width: 326,
  },
  omoneyRequestMoneyFrequentInner: {
    top: 400,
    borderStyle: "solid",
