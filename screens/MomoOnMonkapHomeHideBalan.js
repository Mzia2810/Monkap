...
const MomoOnMonkapHomeHideBalan = () => {
  ...
  return (
    <>
      <View style={styles.momoOnMonkapHomeHideBalan}>
        <Image
        ...
        />
        <View
          style={[styles.momoOnMonkapHomeHideBalanChild, styles.momoLayout]}
        />
        ...
        />
        <View
          style={[styles.momoOnMonkapHomeHideBalanItem, styles.momoLayout]}
        />
        <MtnDataContainer
        ...
        <MomoPayContainer
          ...
          paymentMethodImageUrl={require("../assets/paysvgrepocom-1-11.png")}
          paymentMethodLogoUrl={require("../assets/group168.png")}
          propLeft={98}
          onRectanglePressablePress={() => navigation.navigate("MoMoPay1")}
        />
        <MTNContainer
...
const styles = StyleSheet.create({
  ...
  momoOnMonkapHomeHideBalanChild: {
    top: 491,
  },
  tabArea: {
    top: 574,
  ...
  momoOnMonkapHomeHideBalanItem: {
    top: 420,
  },
  momoOnMonkapHomeHideBalan: {
...
export default MomoOnMonkapHomeHideBalan;
