...
const ViewScheduleKupexan831 = () => {
  ...
  return (
    <>
      <View style={styles.viewScheduleKupexan83}>
        <View
          style={[
            styles.viewScheduleKupexan83Child,
        ...
        <View style={[styles.monkapDigitalNjangiParent, styles.monkapPosition]}>
          ...
          <Text style={styles.kupexanClass}>
            Kupexan - Class of 83 Njangi Details
          </Text>
        </View>
        <View style={[styles.schedulePlaying, styles.schedulePosition]}>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("ViewScheduleKupexan83")}
          />
        </View>
      ...
      <Modal animationType="fade" transparent visible={tabArea2Visible}>
        <View style={styles.tabArea2Overlay}>
          ...
          <AddContact onClose={closeTabArea2} />
        </View>
      </Modal>
    </>
  );
...
export default ViewScheduleKupexan831;
