...
import DailyContributionsForm1 from "../components/DailyContributionsForm1";
import ContainerMonkap from "../components/ContainerMonkap";
import { Color, FontFamily, FontSize, Border } from "../GlobalStyles";

const SaveIrregularly = () => {
  ...
  return (
    <>
      <View style={[styles.saveIrregularly, styles.groupIconLayout]}>
        <View style={[styles.saveIrregularlyChild, styles.groupPosition]} />
        <View
          style={[
...
export default SaveIrregularly;
