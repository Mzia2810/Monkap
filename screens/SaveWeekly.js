...
import FrequencyOptionsContainer from "../components/FrequencyOptionsContainer";
...
const SaveWeekly = () => {
  ...
  return (
    <>
      <View style={[styles.saveWeekly, styles.groupIconLayout]}>
        <View style={[styles.saveWeeklyChild, styles.savePosition]} />
        <View style={[styles.saveWeeklyItem, styles.savePosition]} />
        <View
          style={[
