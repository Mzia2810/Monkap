...
const RequestMoneyRecent = () => {
  ...
  return (
    <>
      <View style={styles.requestMoneyRecent}>
        ...
        />
        <Image
          style={styles.requestMoneyRecentChild}
          resizeMode="cover"
        ...
        />
        <Image
          style={[styles.requestMoneyRecentItem, styles.requestPosition]}
          resizeMode="cover"
          source={require("../assets/line-22.png")}
        />
        <View
          style={[styles.requestMoneyRecentInner, styles.requestPosition]}
        />
        <FrequentRequestsContainer
          onRectanglePressablePress={() =>
            navigation.navigate("RequestMoneyFrequent")
          }
        />
...
const styles = StyleSheet.create({
  ...
  requestMoneyRecentItem: {
    top: 201,
    height: 2,
    width: 326,
  },
  requestMoneyRecentInner: {
    top: 400,
    borderStyle: "solid",
...
export default RequestMoneyRecent;
