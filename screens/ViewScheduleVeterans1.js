...
const ViewScheduleVeterans1 = () => {
  ...
  return (
    <>
      <View style={styles.viewScheduleVeterans}>
        <View
          style={[
            styles.viewScheduleVeteransChild,
        ...
        <View style={[styles.schedulePlaying, styles.schedulePosition]}>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("ViewScheduleVeterans")}
          />
        </View>
...
export default ViewScheduleVeterans1;
