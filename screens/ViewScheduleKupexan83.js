...
const ViewScheduleKupexan83 = () => {
  ...
  return (
    <>
      <View style={[styles.viewScheduleKupexan83, styles.scheduleLayout]}>
        <View style={styles.viewScheduleKupexan83Child} />
        <Pressable
...
export default ViewScheduleKupexan83;
