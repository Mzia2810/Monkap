  ...
  return (
    <>
      <View style={[styles.transferCaution, styles.keysIconLayout]}>
        ...
        />
        <SendButton propBackgroundColor="#feca18" />
        <ReasonContainer
        ...
        <MoneyContainer
          ...
          propBackgroundColor="#feca18"
          onTaAreaPress={() => navigation.navigate("TransferFrequent1")}
        />
        <Pressable
          style={[styles.blurBgd, styles.blurBgdPosition]}
          onPress={() => navigation.navigate("TransferFrequent1")}
        />
        <View style={[styles.caution1, styles.blurBgdPosition]}>
...
export default TransferCaution1;
