...
import VeteransCard from "../components/VeteransCard";
import VeteransNjangiDashboardSection from "../components/VeteransNjangiDashboardSection";
import ContainerMonkap from "../components/ContainerMonkap";
import { Color, Border, FontSize, FontFamily } from "../GlobalStyles";

const NjangiMainDaily1 = () => {
  ...
  return (
    <>
      <View style={styles.njangiMainDaily1}>
        <View style={styles.njangiMainDaily1Child} />
        ...
        <View style={[styles.groupParent, styles.groupLayout]}>
          <View style={[styles.groupContainer, styles.groupLayout]}>
            ...
            <VeteransNjangiDashboardSection />
          </View>
          <Pressable
...
export default NjangiMainDaily1;
